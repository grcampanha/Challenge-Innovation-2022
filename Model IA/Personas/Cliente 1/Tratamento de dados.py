...
def emailTemplate(status, placa, modelo, ano, nome): 
       return """<!DOCTYPE html>
           ...
           <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
           	<tr>
           		<td style="padding: 0 2.5em; text-align: center; padding-bottom: 3em;">
           			<div class="text">
                           <h2>Senhor(a) {nome},</h2>
           				<h2 id="subtitle">Aqui está uma análise diária do seu veículo:</h2>
           			</div>
           		</td>
           	</tr>
           	<tr>
			          <td style="text-align: center;">
			          	<div class="text-author">
				          	...
				          	<h3 class="name">PLACA: {placa}</h3>
				          	<span class="position">MODELO: {modelo} - ANO: {ano}</span>
				           	<p><a class="btn btn-primary">STATUS: {status}</a></p>
				           	<p><a href="https://localhost:7204/" class="btn-custom">Acesse o site</a></p>
			           	</div>
			          </td>
			        </tr>
           </table>
