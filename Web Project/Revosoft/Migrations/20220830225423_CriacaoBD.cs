        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Enderecos_Usuarios_UsuariosId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ano = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    UsuariosId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Veiculos_Usuarios_UsuariosId",
                        column: x => x.UsuariosId,
                        principalTable: "Usuarios",
                        principalColumn: "UsuariosId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PecasId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MotorScore = table.Column<decimal>(type: "decimal(10,2)", maxLength: 3, nullable: false),
                    CambioScore = table.Column<decimal>(type: "decimal(10,2)", maxLength: 3, nullable: false),
                    PneuScore = table.Column<decimal>(type: "decimal(10,2)", maxLength: 3, nullable: false),
                    VeiculosId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pecas_Veiculos_VeiculosId",
                        column: x => x.VeiculosId,
                        principalTable: "Veiculos",
                        principalColumn: "VeiculosId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Enderecos_UsuariosId",
                table: "Enderecos",
                column: "UsuariosId");

            migrationBuilder.CreateIndex(
                name: "IX_Pecas_VeiculosId",
                table: "Pecas",
                column: "VeiculosId");

            migrationBuilder.CreateIndex(
                name: "IX_Veiculos_UsuariosId",
                table: "Veiculos",
                column: "UsuariosId");
        }
