...
namespace Revosoft.Models
{
    public class CarrinhoCompra
    {
        ...
        public void AdicionarAoCarrinho(Store store)
        {
            var carrinhoCompraItem = _context.CarrinhoCompraItens.SingleOrDefault(
                s => s.Store.StoreId == store.StoreId && s.CarrinhoCompraId == CarrinhoCompraId);
        ...
        public int RemoverDoCarrinho(Store store)
        {
            var carrinhoCompraItem = _context.CarrinhoCompraItens.SingleOrDefault(
                s => s.Store.StoreId == store.StoreId && s.CarrinhoCompraId == CarrinhoCompraId);
        ...
        public decimal GetCarrinhoCompraTotal()
        {
            var total = _context.CarrinhoCompraItens.Where(c => c.CarrinhoCompraId == CarrinhoCompraId)
                        .Select(c => c.Store.Preco * c.Quantidade).Sum();
            return total;
        }
    }
}
